<div class="form-group {{ $errors->has('fecha') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="fecha" type="date" id="fecha" value="{{ $acuentum->fecha or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="detalle" type="text" id="detalle" value="{{ $acuentum->detalle or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="credito_id" type="number" id="credito_id" value="{{ $acuentum->credito_id or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="trabajador_id" type="number" id="trabajador_id" value="{{ $acuentum->trabajador_id or ''}}" >
